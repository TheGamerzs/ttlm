...
//    'scrap_acid' => 5,
    $storage = new Storage([
        new \App\TT\Items\InventoryItem('refined_tin', 1, 10),
        new \App\TT\Items\InventoryItem('refined_zinc', 1, 10),
        new \App\TT\Items\InventoryItem('scrap_acid', 1, 5)
    ]);
...
//    'recycled_electronics' => 130,
    ...
    $storage = new Storage([
        ...
        new \App\TT\Items\InventoryItem('refined_zinc', 1, 10),
        new \App\TT\Items\InventoryItem('scrap_acid', 1, 5),
        new \App\TT\Items\InventoryItem('recycled_electronics', 1, 130)
    ]);
